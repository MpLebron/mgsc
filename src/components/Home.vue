<template>
  <div id="Home">
    <div>
      ...
      <hr>
      <div id="vision"> The vision of Modeling Geographical Systems Commission (MGSC) of
        International Geographical Union (IGU) is to share an interest in developing the theories,
        dynamics, simulation and decision-making of geographical systems using statistical and mathematical
        approaches, and further to enhance research on modeling and simulation methods and other technological
        advances for geographic pattern analysis and process exploration.
        <br><br>
      </div>
    </div>
    ...
    <div>
      ...
      <div>
        <router-link to="/Events/2021/1">
          <strong class="home-h"><a id="Call-for-Abstracts">Call for Abstracts | The session of Geographic information modelling and simulation in the era of big data in IGU Paris 2022</a><br></strong>
        </router-link>
        <small class="home-date">June 18 to 22, 2022<br></small>
        <p>The centennial congress of the International Geographical Union (IGU) will
          be held in Paris from June 18 to 22, 2022. Around the theme "Time for Geographers"
          of the congress, the Modeling Geographical Systems Commission (MGSC) of IGU will organize a virtual session–Geographic \
          information modelling and simulation in the era of big data–to promote idea exchange and achievement sharing in this field.<br></p>
