<template>
  <div id="JoinUs">
    ...
    <div>
      ...
      <hr>
      <div class="cos-modal">Membership should be applied through an electronic application form. Membership Application Form should
        be emailed to Chairman and Secretary General. We will email you a unique Member ID. If you have registered this site,
      ...
      <div class="cos-modal">
        ...
        <a href="https://github.com/MpLebron/mgsc/blob/master/src/assets/static/doc/IGU%20MGSC%20Award%20Nomination%20Letter-2022.docx?raw=true"> Membership Application Form</a>
      </div>
    </div>
  </div>
</template>
